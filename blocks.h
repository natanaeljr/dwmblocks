...
{"", R"(free -m | awk '/Mem:/ {free_pc=$4*100/$2; used=$2-$7; used_pc=used*100/$2; unit="M"; if(used>=1000) {used/=1024; unit="G"}; printf("^b#98c379^^c#1e222a^%02.f%%^d^ ^c#98c379^" (unit=="G"?"%.1f":"%d") "%s %02.f%%^d^\n",used_pc,used,unit,free_pc)}')", 3, 2},
{"", R"(
